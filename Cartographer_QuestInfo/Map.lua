...
local CQI_TYPES = {
	...
	["obj-daily"] = {
		title = L["Quest Objective"],
		icon = "Interface\\AddOns\\Cartographer_QuestInfo\\Artwork\\Mark_Daily",
	},
}
...
function CQI:EnableCartoMap()
    ...
    CN:RegisterNotesDatabase(DB_NAME, CQI_NOTES, self, true)
	CN:RefreshMap(true)
end
...
function CQI:ShowActiveQuests(tracked_only, all_zones)
	self:ClearQuestNotes()
	local zone = not all_zones and C:GetCurrentLocalizedZoneName()
