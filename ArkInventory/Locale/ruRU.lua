...
--	wow skill names - must match exactly what is in game
	...
	L["WOW_SKILL_COOKING"] = "Кулинария"
	L["WOW_SKILL_ENCHANTING"] = "Наложение чар"
	L["WOW_SKILL_ENGINEERING"] = "Инженерное дело" -- was Механика
	L["WOW_SKILL_FIRST_AID"] = "Первая помощь"
	L["WOW_SKILL_FISHING"] = "Рыбная ловля"
	L["WOW_SKILL_HERBALISM"] = "Травничество"
	L["WOW_SKILL_INSCRIPTION"] = "Начертание"
	L["WOW_SKILL_JEWELCRAFTING"] = "Ювелирное дело"
	L["WOW_SKILL_LEATHERWORKING"] = "Кожевничество"
	L["WOW_SKILL_MINING"] = "Горное дело"
...
--	wow class names - must match exactly what is in game and must exist
	...
	L["WOW_CLASS_MAGE"] = "Маг"
	L["WOW_CLASS_PALADIN"] = "Паладин"
	L["WOW_CLASS_PRIEST"] = "Жрец"
	L["WOW_CLASS_ROGUE"] = "Разбойник"
	L["WOW_CLASS_SHAMAN"] = "Шаман"
...
--	wow item types - must match exactly what is in game
	...
	L["WOW_ITEM_TYPE_CONSUMABLE_BANDAGE"] = "Бинты"
	L["WOW_ITEM_TYPE_CONSUMABLE_ELIXIR"] = "Эликсир"
	L["WOW_ITEM_TYPE_CONSUMABLE_FLASK"] = "Фляга"
	L["WOW_ITEM_TYPE_CONSUMABLE_FOOD_AND_DRINK"] = "Еда и напитки"
	L["WOW_ITEM_TYPE_CONSUMABLE_POTION"] = "Зелье"
	L["WOW_ITEM_TYPE_CONSUMABLE_SCROLL"] = "Свиток"
	L["WOW_ITEM_TYPE_CONTAINER"] = "Сумки"
	L["WOW_ITEM_TYPE_CONTAINER_BAG"] = "Сумка"
	L["WOW_ITEM_TYPE_CONTAINER_ENCHANTING"] = "Сумка зачаровывателя"
	L["WOW_ITEM_TYPE_CONTAINER_ENGINEERING"] = "Сумка инженера"
	L["WOW_ITEM_TYPE_CONTAINER_GEM"] = "Сумка ювелира"
	L["WOW_ITEM_TYPE_CONTAINER_HERB"] = "Сумка травника"
	L["WOW_ITEM_TYPE_CONTAINER_INSCRIPTION"] = "Сумка начертателя"
	L["WOW_ITEM_TYPE_CONTAINER_LEATHERWORKING"] = "Сумка кожевника"
	L["WOW_ITEM_TYPE_CONTAINER_MINING"] = "Сумка шахтера"
	L["WOW_ITEM_TYPE_CONTAINER_SOULSHARD"] = "Сумка душ"
	L["WOW_ITEM_TYPE_GEM"] = "Самоцветы"
--	L["WOW_ITEM_TYPE_GLYPH"] = ""
	L["WOW_ITEM_TYPE_KEY"] = "Ключ"
	L["WOW_ITEM_TYPE_MISC"] = "Разное"
	L["WOW_ITEM_TYPE_MISC_MOUNT"] = "Верховые животные"
	L["WOW_ITEM_TYPE_MISC_PET"] = "Питомцы"
	L["WOW_ITEM_TYPE_MISC_REAGENT"] = "Реагенты"
	L["WOW_ITEM_TYPE_PROJECTILE"] = "Боеприпасы"
	L["WOW_ITEM_TYPE_PROJECTILE_ARROW"] = "Стрелы"
	L["WOW_ITEM_TYPE_PROJECTILE_BULLET"] = "Пули"
	L["WOW_ITEM_TYPE_QUEST"] = "Задания"
	L["WOW_ITEM_TYPE_QUIVER"] = "Амуниция"
	L["WOW_ITEM_TYPE_QUIVER_ARROW"] = "Колчан"
	L["WOW_ITEM_TYPE_QUIVER_BULLET"] = "Подсумок"
	L["WOW_ITEM_TYPE_RECIPE"] = "Рецепты"
	L["WOW_ITEM_TYPE_TRADE_GOODS"] = "Хозяйственные товары"
	L["WOW_ITEM_TYPE_TRADE_GOODS_CLOTH"] = "Ткань"
	L["WOW_ITEM_TYPE_TRADE_GOODS_DEVICES"] = "Устройства"
	L["WOW_ITEM_TYPE_TRADE_GOODS_ELEMENTAL"] = "Стихии"
	L["WOW_ITEM_TYPE_TRADE_GOODS_ENCHANTMENT_ARMOR"] = "Чары для оружия"
	L["WOW_ITEM_TYPE_TRADE_GOODS_ENCHANTMENT_WEAPON"] = "Чары для доспехов"
	L["WOW_ITEM_TYPE_TRADE_GOODS_EXPLOSIVES"] = "Взрывчатка"
	L["WOW_ITEM_TYPE_TRADE_GOODS_HERB"] = "Трава"
	L["WOW_ITEM_TYPE_TRADE_GOODS_LEATHER"] = "Кожа"
	L["WOW_ITEM_TYPE_TRADE_GOODS_MEAT"] = "Мясо"
...
--	category "header" descriptions  (does not have to match wow)
	...
	L["CATEGORY_CUSTOM"] = "Особые"
	L["CATEGORY_EMPTY"] = "Пусто"
...
--	system category descriptions
	...
	L["CATEGORY_SYSTEM_REPUTATION"] = "Репутация"
	L["CATEGORY_SYSTEM_SOULBOUND"] = "Персональное"
...
--	L["STATUS_NAME_MOUNT"] = ""
	L["STATUS_NAME_PROJECTILE"] = "Боепр"
	L["STATUS_NAME_PROJECTILE_ARROW"] = "Стрела"
...
--	item menu
	...
	L["MENU_ITEM_MOVE"] = "Переместить %1$s в набор"
...
--	L["MENU_ITEM_DEBUG_CLASS"] = ""
	L["MENU_ITEM_DEBUG_QUALITY"] = "Качество"
...
--	L["MENU_ITEM_DEBUG_ID"] = ""
	L["MENU_ITEM_DEBUG_STACK"] = "Размер пачки"
...
--	L["CONFIG_SYSTEM_TOOLTIP_ITEMCOUNT_VAULT_TABS_TEXT"] = ""
	L["CONFIG_SYSTEM_TOOLTIP_VENDOR_ADD"] = "Показывать цену продажи"
	L["CONFIG_SYSTEM_TOOLTIP_VENDOR_ADD_TEXT"] = "показывать в тултипе цену продажи предмета продавцу."
	L["CONFIG_SYSTEM_TOOLTIP_VENDOR_COLOUR_TEXT"] = "задает цвет текста для цены продажи."
...
--	L["MOVE"] = ""
	...
	L["DEFAULT"] = "Назначение по умолчанию"
	L["OFFSET"] = "Сдвиг"
--	L["NUMBER"] = ""
--	L["STRING"] = ""
--	L["COOLDOWN"] = ""
