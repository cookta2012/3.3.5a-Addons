...
--Plate
	...
	AtlasLoot_Data["CardGame1"] = {
		...
		{ 9, 49289, "", "=q2=Little White Stallion Bridle", "=ds=#ud40#"};
		{ 10, 49288, "", "=q2=Little Ivory Raptor Whistle", "=ds=#ud40#"};
		{ 12, 0, "INV_Box_01", "=q6=#ud4#", "=q1=#ud35#"};
		{ 13, 49290, "", "=q4=Magic Rooster Egg", "=ds=#ud38#"};
		{ 14, 46780, "", "=q3=Ogre Pinata", "=ds=#ud37#"};
		{ 15, 46779, "", "=q1=Path of Cenarius", "=ds=#ud36#"};
		{ 16, 0, "INV_Box_01", "=q6=#ud4#", "=q1=#ud31#"};
		{ 17, 45037, "", "=q4=Epic Purple Shirt", "=ds=#ud32#"};
		{ 18, 45063, "", "=q3=Foam Sword Rack", "=ds=#ud33#"};
		{ 19, 45047, "", "=q3=Sandbox Tiger", "=ds=#ud34#"};
		{ 21, 0, "INV_Box_01", "=q6=#ud4#", "=q1=#ud27#"};
		{ 22, 49282, "", "=q4=Big Battle Bear", "=ds=#ud28#"};
		{ 23, 38578, "", "=q3=The Flag of Ownership", "=ds=#ud29#"};
		{ 24, 38577, "", "=q1=Party G.R.E.N.A.D.E.", "=ds=#ud30#"};
		{ 26, 0, "INV_Box_01", "=q6=#ud4#", "=q1=#ud23#"};
		{ 27, 38050, "", "=q3=Soul-Trader Beacon", "=ds=#ud26#"};
		{ 28, 38301, "", "=q3=D.I.S.C.O", "=ds=#ud25#"};
		{ 29, 38233, "", "=q1=Path of Illidan", "=ds=#ud24#"};
		Next = "CardGame2";
		Back = "SETMENU";
	};

	AtlasLoot_Data["CardGame2"] = {
		{ 1, 0, "INV_Box_01", "=q6=#ud4#", "=q1=#ud19#"};
		{ 2, 35227, "", "=q4=Goblin Weather Machine - Prototype 01-B", "=ds=#ud21#"};
		{ 3, 49286, "", "=q4=X-51 Nether-Rocket X-TREME", "=ds=#ud22#"};
		{ 4, 49285, "", "=q3=X-51 Nether-Rocket", "=ds=#ud22#"};
		{ 5, 35223, "", "=q3=Papa Hummel's Old-Fashioned Pet Biscuit", "=ds=#ud20#"};
		{ 7, 0, "INV_Box_01", "=q6=#ud4#", "=q1=#ud15#"};
		{ 8, 34493, "", "=q4=Dragon Kite", "=ds=#ud16#"};
		{ 9, 34492, "", "=q3=Rocket Chicken", "=ds=#ud17#"};
		{ 10, 34499, "", "=q3=Paper Flying Machine Kit", "=ds=#ud18#"};
	...
	AtlasLoot_Data["PetsEvent1"] = {
		...
		{ 7, 46707, "", "=q3=Pint-Sized Pink Pachyderm", "=ds=#e13#"};
		{ 8, 34955, "", "=q3=Scorched Stone", "=ds=#e13#"};
		{ 9, 33154, "", "=q3=Sinister Squashling", "=ds=#e13#"};
		{ 10, 32617, "", "=q3=Sleepy Willy", "=ds=#e13#"};
		{ 11, 44794, "", "=q3=Spring Rabbit's Foot", "=ds=#e13#"};
		{ 12, 32233, "", "=q3=Wolpertinger's Tankard", "=ds=#e13#"};
		{ 13, 50446, "", "=q3=Toxic Wasteling", "=ds=#e13#"};
		{ 14, 21301, "", "=q1=Green Helper Box", "=ds=#e13#"};
		{ 15, 21308, "", "=q1=Jingling Bell", "=ds=#e13#"};
		{ 16, 23007, "", "=q1=Piglet's Collar", "=ds=#e13#"};
		{ 17, 23015, "", "=q1=Rat Cage", "=ds=#e13#"};
		{ 18, 21305, "", "=q1=Red Helper Box", "=ds=#e13#"};
		{ 19, 21309, "", "=q1=Snowman Kit", "=ds=#e13#"};
		{ 20, 22235, "", "=q1=Truesilver Shafted Arrow", "=ds=#e13#"};
		{ 21, 23002, "", "=q1=Turtle Box", "=ds=#e13#"};
		Prev = "PetsRare1";
