...
-- /rb statmod
L["Enable Stat Mods"] = "애드온 사용"
L["Enable support for Stat Mods"] = "애드온을 활성화합니다."
-- /rb avoidancedr
...
-- /rb rating spell
L["Show Spell Hit"] = "주문 적중 표시"
L["Show Spell Hit from Hit Rating"] = "적중도에 의한 주문 적중을 표시합니다."
-- /rb rating physical
L["Show Physical Hit"] = "물리 적중 표시"
L["Show Physical Hit from Hit Rating"] = "적중도에 의한 물리 적중을 표시합니다."
-- /rb rating detail
...
L["Show stat summary only for highest level armor type and items you can use with uncommon quality and up"] = "능력치 요약 계산에 자신이 사용할 수 있는 가장 높은 방어도 유형과 고급(녹색) 품질 이상의 아이템만 포함시킵니다."
...
L["$value Dmg"] = "주문 공격력 $value"
L["$value Heal"] = "치유량 $value"
L["$value Armor"] = "방어도 $value"
L["$value Block"] = "방어량 $value"
