...
L["Show Spell Hit from Hit Rating"] = "顯示命中給的法術命中"
-- /rb rating physical
L["Show Physical Hit"] = "顯示物理命中"
L["Show Physical Hit from Hit Rating"] = "顯示命中給的物理命中"
-- /rb rating detail
...
L["Ignore unused items types"] = "忽略不會使用的物品"
L["Show stat summary only for highest level armor type and items you can use with uncommon quality and up"] = "只在你會使用的物品顯示屬性統計"
