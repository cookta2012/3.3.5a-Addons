...
-- /rb rating show
L["Show Rating conversions"] = "Показывать конвертацию рейтингов"
L["Show Rating conversions in tooltips"] = "Показывать конвертацию рейтингов в подсказке"
-- /rb rating spell
L["Show Spell Hit"] = "Показывать меткость заклинаний"
L["Show Spell Hit from Hit Rating"] = "Показывать меткость заклинаний из рейтинга меткости"
-- /rb rating physical
L["Show Physical Hit"] = "Показывать меткость физических атак"
L["Show Physical Hit from Hit Rating"] = "Показывать меткость физических атак из рейтинга меткости"
-- /rb rating detail
L["Show detailed conversions text"] = "Показывать детальную конвертацию рейтингов"
...
-- /rb stat str ap
L["Show Attack Power"] = "Показывать изменение СА"
L["Show Attack Power from Strength"] = "Показывать изменение силы атаки от силы"
-- /rb stat str block
L["Show Block Value"] = "Показывать изменение блокирования"
L["Show Block Value from Strength"] = "Показывать изменение блокирования силы"
-- /rb stat str dmg
L["Show Spell Damage"] = "Показывать изменение урона заклинаниями"
L["Show Spell Damage from Strength"] = "Показывать изменение урона заклинаниями от силы"
-- /rb stat str heal
L["Show Healing"] = "Показывать изменения исцеления"
L["Show Healing from Strength"] = "Показывать изменение исцеления от силы"
-- /rb stat str parry
L["Show Parry"] = "Показывать изменения парирования"
...
-- /rb stat agi crit
L["Show Crit"] = "Показывать изменение крита"
L["Show Crit chance from Agility"] = "Показывать изменение крита от ловкости"
-- /rb stat agi dodge
L["Show Dodge"] = "Показывать изменение уклонения"
...
-- /rb stat sta hp
L["Show Health"] = "Показывать изменение здоровья"
...
-- /rb stat sta ap
L["Show Attack Power"] = "Показывать изменение силы атаки"
...
L["Show Spell Crit"] = "Показывать изменение крита заклинаниями"
L["Show Spell Crit chance from Intellect"] = "Показывать изменение крита заклинаниями от интеллекта"
-- /rb stat int mp
L["Show Mana"] = "Показывать изменение маны"
L["Show Mana from Intellect"] = "Показывать изменение маны от интеллекта"
-- /rb stat int dmg
L["Show Spell Damage"] = "Показывать изменение урона заклинаниями"
L["Show Spell Damage from Intellect"] = "Показывать изменение урона заклинаниями от интеллекта"
-- /rb stat int heal
L["Show Healing"] = "Показывать изменение исцеления"
L["Show Healing from Intellect"] = "Показывать изменение исцеления от интеллекта"
-- /rb stat int mp5
L["Show Mana Regen"] = "Показывать изменение манарегена"
L["Show Mana Regen while casting from Intellect"] = "Показывать изменение манарегена от интеллекта"
-- /rb stat int mp5nc
L["Show Mana Regen while NOT casting"] = "Показывать изменение манарегена(вне каста)"
L["Show Mana Regen while NOT casting from Intellect"] = "Показывать изменение манарегена (вне каста)"
-- /rb stat int rap
L["Show Ranged Attack Power"] = "Показывать изменение САДБ"
...
-- /rb stat spi mp5
L["Show Mana Regen"] = "Показывать изменение манарегена"
L["Show Mana Regen while casting from Spirit"] = "Показывать изменение манарегена от духа"
-- /rb stat spi mp5nc
L["Show Mana Regen while NOT casting"] = "Показывать изменение манарегена (вне каста)"
L["Show Mana Regen while NOT casting from Spirit"] = "Показывать изменение манарегена (вне каста)"
-- /rb stat spi hp5
L["Show Health Regen"] = "Показывать изменение восстановления здоровья"
L["Show Health Regen from Spirit"] = "Показывать изменение восстановления здоровья от духа"
-- /rb stat spi dmg
L["Show Spell Damage"] = "Показывать изменение урона заклинаниями"
L["Show Spell Damage from Spirit"] = "Показывать изменение урона заклинаниями от духа"
-- /rb stat spi heal
L["Show Healing"] = "Показывать изменение исцеления"
...
L["Ignore unused items types"] = "Игнорировать неиспользуемые типы предметов"
L["Show stat summary only for highest level armor type and items you can use with uncommon quality and up"] = "Показать итоги только для высоко уровневого типа брони и предметов, которые вы можете использовать, начиная с предметов необычного качества и выше"
