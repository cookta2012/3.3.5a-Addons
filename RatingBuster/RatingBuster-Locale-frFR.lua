...
L["Suspend/resume this addon"] = "Suspend/active cet addon"
---------------------------
...
-- /rb sum stat
--L["Stat - Base"] = "Stat Base"
--L["Choose base stats for summary"] = "Choisir les Stats de base pour le Résumé"
-- /rb sum stat hp
