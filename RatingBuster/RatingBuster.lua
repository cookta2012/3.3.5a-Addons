...
LastUpdate: $Date: 2009-09-25 16:19:30 +0000 (Fri, 25 Sep 2009) $
]]
...
RatingBuster.version = "1.4.7 (r"..gsub("$Revision: 252 $", "(%d+)", "%1")..")"
RatingBuster.date = gsub("$Date: 2009-09-25 16:19:30 +0000 (Fri, 25 Sep 2009) $", "^.-(%d%d%d%d%-%d%d%-%d%d).-$", "%1")
