...
Inst1Quest7_Note = "Baros Alexston befindet sich in Sturmwind, neben der Kathedrale des Lichts bei "..YELLOW.."57.7, 47.9"..WHITE.."."
...
Inst18Quest5_Location = "Furen Langbart (Sturmwind - Zwergendistrikt; "..YELLOW.."64.4, 37.3"..WHITE..")"
Inst18Quest5_Note = "Diese Quest kann nur von Kriegern angenommen werden. Die Phiole mit Phlogiston bekommt man von Roogug bei "..YELLOW.."[1]"..WHITE..".\n\nDie Folgequest ist für jede Rasse unterschiedlich. Brennendes Blut für Menschen, Eisenkoralle für Zwerge und Gnome und Sonnenverbrannte Schalen für Nachtelfen."
...
Inst18Quest5_HORDE_Note = "Diese Quest kann nur von Kriegern angenommen werden. Die Phiole mit Phlogiston bekommt man von Roogug bei "..YELLOW.."[1]"..WHITE..".\n\nWenn man diese Quest abschließt, erhält man die Möglichkeit vier neue Folgequests von dem selben NPC anzunehmen."
...
Inst19Quest2_Note = "Diese Quest kann nur von Magiern angenommen werden. Das Buch findet man im letzten Korridor, der zu Arkanist Doan ("..YELLOW.."[2]"..WHITE..") führt."
...
Inst57Quest1_Note = "Diese Questreihe beginnt bei Bruder Crowley in Sturmwind - Kathedrale des Lichts ("..YELLOW.."52.1, 43.1"..WHITE..").\nHochinquisitorin Weißsträhne und Kommandant Mograine findet man bei "..YELLOW.."SK: Kathedrale [2]"..WHITE..", Herod bei "..YELLOW.."SK: Waffenkammer [1]"..WHITE.." und Hundemeister Loksey bei "..YELLOW.."SK: Bibliothek [1]"..WHITE.."."
...
Inst58Quest1_Note = "Diese Questreihe beginnt bei Bruder Crowley in Sturmwind - Kathedrale des Lichts ("..YELLOW.."52.1, 43.1"..WHITE..").\nHochinquisitorin Weißsträhne und Kommandant Mograine findet man bei "..YELLOW.."SK: Kathedrale [2]"..WHITE..", Herod bei "..YELLOW.."SK: Waffenkammer [1]"..WHITE.." und Hundemeister Loksey bei "..YELLOW.."SK: Bibliothek [1]"..WHITE.."."
...
Inst59Quest1_HORDE_Note = "Vorrel Sengutz befindet sich am Anfang des Friedhofs vom Scharlachroten Kloster. Nancy Vishas, die den Ring droppt, der für diese Quest benötigt wird, befindet sich in einem Haus im Alteracgebirge ("..YELLOW.."31,32"..WHITE..")."
...
Inst20Quest9_Note = "Die Quest kann nur von Hexenmeistern angenommen werden! Das Alchimielabor befindet sich bei "..YELLOW.."[7]"..WHITE.."."
...
Inst22Quest18_Note = "Um Eris Himmelsfeuer sehen zu können und diese Quest zu erhalten benötigt man entweder das Auge der Offenbarung (erhält man aus dem Behälter des Feuerfürsten im "..YELLOW.."[Geschmolzenen Kern]"..WHITE..") oder Spektrale Essenz (Belohnung für "..YELLOW.."[Scholomance]"..WHITE.." Quest 'Kirtonos der Herold').\n\nDie Belohnung für diese Quest bildet zusammen mit dem Auge der Offenbarung und dem Auge der Schatten (droppt von "..YELLOW.."[Hochlord Kruul]"..WHITE..") Segnung, einen epischen Priesterstab."
...
Inst24Quest3_Location = "Aufseher Thelwasser (Sturmwind - Das Verlies; "..YELLOW.."51.4, 68.8"..WHITE..")"
Inst24Quest3_Note = ""
...
Inst24Quest4_Location = "Nikova Raskol (Sturmwind - Die Altstadt; "..YELLOW.."75.6, 62.9"..WHITE..")"
...
Inst24Quest6_Location = "Aufseher Thelwasser (Sturmwind - Das Verlies; "..YELLOW.."51.4, 68.8"..WHITE..")"
...
Inst25Quest1_Location = "Brohann Fassbauch (Sturmwind - Zwergendistrikt; "..YELLOW.."69.5, 40.4"..WHITE..")"
...
Inst27Quest7_Note = "Die Vorquest erhält man von Klockmort Spannersplint (Eisenschmiede - Tüftlerstadt; "..YELLOW.."68,46"..WHITE.."). Es ist allerdings nicht nötig die Vorquest abzuschließen, um diese Quest zu erhalten.\nGahz'rilla kann man bei "..YELLOW.."[6]"..WHITE.." mit dem Schlag auf die Glocke in Zul'Farrak beschwören werden.\nDen Schlaghammer von Zul'Farrak wird nicht mehr benötigt!Änderung  mit Patch 3.0"
...
Inst29Quest4_Location = "Shoni die Schtille (Sturmwind - Zwergendistrikt; "..YELLOW.."62.6, 34.1"..WHITE..")"
...
Inst29Quest5_Note = "Die Vorquest bekommt man von Mathiel (Darnassus - Terrasse der Krieger; "..YELLOW.."59,45"..WHITE.."). Es ist jedoch nicht nötig die Vorquest abzuschließen, um diese Quest zu erhalten.\nDie Grundlegenden Artifixe droppen von Maschinen, die in der ganzen Instanz verteilt sind."
...
--Quest 11 Alliance
Inst29Quest11 = "11. Der Funkelmat 5200!"
